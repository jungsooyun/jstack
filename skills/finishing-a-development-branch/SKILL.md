...
**Called by:**
- **jstack:subagent-driven-development** - After all tasks complete
- **jstack:executing-plans** - After all batches complete

**Pairs with:**
- **jstack:using-git-worktrees** - Cleans up worktrees under jstack-owned paths
